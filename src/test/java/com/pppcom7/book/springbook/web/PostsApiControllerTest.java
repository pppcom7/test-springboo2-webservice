package com.pppcom7.book.springbook.web;
...
public class PostsApiControllerTest {
    ...
    @Test
    public void registed_posts() throws Exception{
        String title = "title";
    ...
    @Test
    public void updated_posts() throws Exception{
    ...
    @Test
    public void BaseTimeEntiry_registed(){
        LocalDateTime now = LocalDateTime.of(2023,10,31,2,45,0);
